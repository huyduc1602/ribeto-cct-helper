    ...
    <div class="cct-faqs-item">
        ...
        <span class="cct-accordion-icon cct-accordion-icon-left" aria-hidden="true">
		    <span class="cct-accordion-icon-closed">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0 12C0 5.37258 5.37258 0 12 0C18.6274 0 24 5.37258 24 12C24 18.6274 18.6274 24 12 24C5.37258 24 0 18.6274 0 12ZM11.2 17.6V12.8H6.4V11.2H11.2V6.4H12.8V11.2H17.6V12.8H12.8V17.6H11.2Z" fill="#E01D19"/>
                </svg>
            </span>
